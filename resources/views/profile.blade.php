                ...
                <div
                    ...
                    <div class="flex flex-col items-center pb-10">
                        ...
                        @elseif ($user->mahasiswa)
                            ...
                            <span class="text-sm text-gray-500 dark:text-gray-400">{{ $user->mahasiswa->gender }}</span>
                        @endif
                        <span class="text-sm text-gray-500 dark:text-gray-400">{{ $user->nim }}</span>
                    </div>
                    <a href="{{ route('profile.edit', $user) }}"
                        class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</a>
                </div>
            </div>
    </section>
</body>
